...
function Plumbing() {
  ...
  return (
    <div>
        <div>
          <Zoom>
        <div className="m-auto text-center"><h3 className="text-red-red1 font-extrabold text-3xl pt-10">OUR<br />Plumbing</h3> <hr className="bg-red-red1 h-1 w-28 rounded-md m-auto" /></div>
      </Zoom>
